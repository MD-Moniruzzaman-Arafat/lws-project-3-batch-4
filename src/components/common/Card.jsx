      ...
      >
        ...
        <div className="flex items-center gap-2 mb-3">
          <span
            ...
            } ${task.tag === 'operations' && 'bg-amber-50 text-amber-700'} ${
              task.tag === 'marketing' && 'bg-green-50 text-green-700'
            } ${task.tag === 'creative' && 'bg-purple-50 text-purple-700'} ${
              task.tag === 'development' && 'bg-indigo-50 text-indigo-700'
            } ${task.tag === 'backend' && 'bg-red-50 text-red-700'} ${
              task.tag === 'setup' && 'bg-green-50 text-green-700'
            } ${task.tag === 'infrastructure' && 'bg-blue-50 text-blue-700'} ${
              task.tag === 'documentation' && 'bg-cyan-50 text-cyan-700'
            }
